  ...
  <div class="min-h-full">
    <nav class="bg-gray-800" x-data="{ isOpen: false }">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="/credit" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Credit</a>
              </div>
            </div>
          </div>
          <div class="hidden md:block">
      ...
      <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
          ...
          <a href="/credit" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Credit</a>
        </div>
    ...
    <main>
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 text-white">
        <!-- Your content -->
        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Hic illo quis odio quidem aspernatur numquam, deleniti quia impedit iusto rerum error beatae suscipit similique, est deserunt debitis nihil voluptatum sunt.</p>
      </div>
    </main>
  </div>
</body>
